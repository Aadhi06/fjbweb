...
class SettingController extends Controller
{
    public function index(): JsonResponse
    {
        return response()->json([
            'data' => [
                ...
                'trustindex_widget_id' => Setting::get('trustindex_widget_id', 'bbaf65d82db81281c8362394a13'),
                'trustindex_inbox_url' => Setting::get('trustindex_inbox_url', 'https://admin.trustindex.io/'),
    ...
    public function update(Request $request): JsonResponse
    {
        $allowedKeys = [
            ...
            'trustindex_widget_id', 'trustindex_inbox_url',
            'google_rating', 'total_reviews', 'years_in_business',
            'happy_customers', 'total_sales', 'gtm_id', 'ga_id', 'meta_pixel_id', 'clarity_id',
        ...
        foreach ($data as $key => $value) {
            if (in_array($key, $allowedKeys)) {
                ...
                $group = match (true) {
                    ...
                    str_starts_with($key, 'google_') || str_starts_with($key, 'trustindex_') || $key === 'trustpilot_url' => 'google',
                    in_array($key, ['gtm_id', 'ga_id', 'meta_pixel_id', 'clarity_id']) => 'tracking',
