...
class CustomerBookingReminder extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Appointment Reminder — Fine Jewellery Buyers',
        );
    }
    ...
    private function buildHtml(): string
    {
        ...
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
            ...
            <div style="background:#ffffff;border:1px solid #e5e7eb;border-top:none;padding:24px;border-radius:0 0 8px 8px;">
                <h2 style="margin:0 0 12px;font-size:16px;color:#111827;">Appointment Reminder</h2>
                <p style="margin:0 0 16px;color:#374151;font-size:14px;line-height:1.6;">
                    Dear {$name}, this is a friendly reminder of your upcoming appointment with us.
                </p>
