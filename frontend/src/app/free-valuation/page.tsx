...
const fallbackForm: DynamicForm = {
  ...
  fields: [
    ...
    { id: 6, name: "photos", label: "Upload Photos", type: "file", required: false, order: 6 },
    { id: 7, name: "preferred_contact", label: "Preferred Contact Method", type: "radio", required: true, options: ["Phone", "Email", "WhatsApp"], order: 7 },
    { id: 8, name: "consent", label: "I agree to the privacy policy", type: "checkbox", required: true, order: 8 },
  ],
};
